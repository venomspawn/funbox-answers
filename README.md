...
требованиям ACID. Базу данных можно использовать в качестве хранилища аватаров,
а СУБД — для сохранения и извлечения аватаров.
...
Решение задачи можно найти в [одном из моих
репозиториев](https://github.com/venomspawn/funbox-nmax-ruby).

### Q2

Решение задачи можно найти в [ещё одном из моих
репозиториев](https://github.com/venomspawn/funbox-drate).
